...
function setBotResponse(response) {    
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var BotResponse = '<img class="botAvatar" src="./static/img/sara_avatar.png"/><p class="botMsg" id="text-to-speech">' + fallbackMsg + '</p><div class="clearfix"></div>';
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (response[i].hasOwnProperty("text")) {
                    ...
                    var BotResponse = '<img class="botAvatar" src="./static/img/sara_avatar.png"/><p class="botMsg" id="text-to-speech">' + response[i].text + '</p><div class="clearfix"></div>';
                    $(BotResponse).appendTo(".chats").hide().fadeIn(1000);
...
function textToAudio() {
            //alert();
            //alert($(".botMsg").text());
            //let msg = document.getElementById("text-to-speech").text();
            
            //let msg = document.getElementByClassName("botMsg").last().text();
            //console.log(msg);
            let msg = $(".botMsg").last().text();
